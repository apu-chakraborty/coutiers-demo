...
function ProfessionalProfileBody() {
  ...
  return (
        ...
        <div className={styles.brokerProfileRow}>
          <div className={styles.brokerProfileLeftPrt}>
            <div className={styles.brokerProfilePic}>
              <img src={"../../../assets/images/professional-profile-pic.jpg"} alt="" />
            </div>
            ...
            <div className={styles.profileLeftPrtIcon}>
              <ul>
                ...
                <li><a href="#">
                  <img src={"../../../assets/images/globe-icon2.png"} alt="" />
                </a></li>
                <li><a href="#">
          ...
          <div className={styles.brokerProfileMiddlePrt}>
            <div className={styles.profileRightNameRow}>
              <h1>David Williams<span>Photographer (professional)</span></h1>
    ...
    <div className={styles.brokerProfessionalInfo}>
      <div className={styles.containerfluid}>
        <h2>David's Professional Information</h2>
          ...
          <div className={styles.brokerProfessionalInfoLeftClm}>
            <div className={styles.brokerProfessionalInfoTable}>
              {/* <table>
                ...
                <tr>
                  <td>Accept Flat Brokerage Fee: <span>Yes</span></td>
                ...
                <tr>
                  <td>Skills</td>
                  <td>
                    <div className={styles.brokerSkill}>
                      <ul>
                        <li>Proactive</li>
...
export default ProfessionalProfileBody;