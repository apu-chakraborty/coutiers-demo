    ...
    <div>
      <div className={styles.reviewSec}>
        <div className={styles.containerfluid}>
          ...
          <OwlCarousel className="owl-theme reviewCarousel" items={1} loop margin={10} autoplay ={false} autoplayTimeout={5000} slideSpeed={300} smartSpeed={2500} nav={true} dots={false} responsiveClass={true}>
